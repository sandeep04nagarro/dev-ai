...
TRACE_REPLY_TIPS: tuple[str, ...] = (
    ...
    "Tag `@dev-agent` on a Linear issue and I'll pull in the full title, description, and comment thread before starting.",
    "I also pick up `@dev-agent` mentions in GitHub issue bodies and comments — not just on PRs.",
